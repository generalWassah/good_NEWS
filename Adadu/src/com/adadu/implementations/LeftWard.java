...
public class LeftWard {
    ...
    public String getLastOrbit(String newText, char selectNEWS){
        ...
        String lastOrbit="";
        if (selectNEWS=='N'){
            lastOrbit = leftWardReversed.getFirstOrbit(newText,'S');
        }else if (selectNEWS=='E'){
            lastOrbit = leftWardReversed.getFirstOrbit(newText,'W');
        }else if (selectNEWS=='W'){
            lastOrbit = leftWardReversed.getFirstOrbit(newText,'E');
        }else if (selectNEWS=='S'){
            lastOrbit = leftWardReversed.getFirstOrbit(newText,'N');
        }
        return lastOrbit;
    } // last orbit
